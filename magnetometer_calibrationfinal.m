...
% output info
fprintf('In the Razor_AHRS.ino, under "SENSOR CALIBRATION" the section that reads "Magnetometer (extended calibration)"\n');
fprintf('We replace the existing 3 lines of magnetometer calibration with these:\n\n');
